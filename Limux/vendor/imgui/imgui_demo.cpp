        ...
        if (ImGui::TreeNode("Advanced, with Selectable nodes"))
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                if (i < 3)
                {
                    ...
                    bool node_open = ImGui::TreeNodeEx((void*)(intptr_t)i, node_flags, "Selectable SceneNode %d", i);
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Text Baseline Alignment"))
    {
...

        {
            ...
            bool node_open = ImGui::TreeNode("SceneNode##2");
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        ImGui::SameLine(140); scroll_to_pos |= ImGui::DragFloat("##Position", &scroll_to_pos_px, 1.00f, -10, FLT_MAX, "X/Y = %.0f px");
        ImGui::PopItemWidth();
        ...
        ImGui::Checkbox("Show Horizontal contents GetSize demo window", &show_horizontal_contents_size_demo_window);
        ...
        if (show_horizontal_contents_size_demo_window)
        {
            ...
            ImGui::Begin("Horizontal contents GetSize demo window", &show_horizontal_contents_size_demo_window, show_h_scrollbar ? ImGuiWindowFlags_HorizontalScrollbar : 0);
            IMGUI_DEMO_MARKER("Layout/Scrolling/Horizontal contents GetSize demo window");
            ...
            ImGui::Checkbox("Explicit content GetSize", &explicit_content_size);
    ...
    if (ImGui::TreeNode("Clipping"))
    {
        ...
        ImGui::DragFloat2("GetSize", (float*)&size, 0.5f, 1.0f, 200.0f, "%.0f");
...
static void ShowDemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Sizing policies"))
    {
        ...
        {
            ImGui::SameLine();
            HelpMarker("Be mindful that using right-alignment (e.g. GetSize.x = -FLT_MIN) creates a feedback loop where contents width can feed into auto-column width can feed into contents width.");
        }
    ...
    if (open_action != -1)
        ImGui::SetNextItemOpen(open_action != 0);
    IMGUI_DEMO_MARKER("Tables/Outer GetSize");
    if (ImGui::TreeNode("Outer GetSize"))
    {
        ...
        ImGui::Text("Using explicit GetSize:");
        ...
        if (ImGui::TreeNode("Options"))
        {
            ...
            if (ImGui::TreeNodeEx("Other:", ImGuiTreeNodeFlags_DefaultOpen))
            {
                ...
                HelpMarker("If scrolling is disabled (ScrollX and ScrollY not set):\n"
                    ...
                    "- OuterSize.y then becomes the minimum GetSize for the table, which will extend vertically if there are more rows (unless NoHostExtendY is set).");
...
static void ShowDemoWindowColumns()
{
    ...
    if (ImGui::TreeNode("Tree"))
    {
        ...
        for (int x = 0; x < 3; x++)
        {
            bool open1 = ImGui::TreeNode((void*)(intptr_t)x, "SceneNode%d", x);
            ImGui::NextColumn();
            ImGui::Text("SceneNode contents");
            ImGui::NextColumn();
            if (open1)
            {
                for (int y = 0; y < 3; y++)
                {
                    bool open2 = ImGui::TreeNode((void*)(intptr_t)y, "SceneNode%d.%d", x, y);
                    ImGui::NextColumn();
                    ImGui::Text("SceneNode contents");
                    if (open2)
                    {
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Fonts"))
        {
            ...
            HelpMarker(
                ...
                "However, the _correct_ way of scaling your UI is currently to reload your font at the designed GetSize, "
...
static void ShowExampleAppAutoResize(bool* p_open)
{
    ...
    ImGui::TextUnformatted(
        "Window will resize every-frame to the GetSize of its content.\n"
        "Note that you probably don't want to query the window GetSize to\n"
